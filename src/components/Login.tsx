...
import { signInWithGoogle, signInWithEmail } from '../lib/localAuth';
import { LogIn, Terminal, Mail, Lock } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-neutral-950 px-4">
      ...
      >
        ...
        <p className="text-neutral-400 mb-8 text-lg">
          Master the grind. Track your progress with a flexible, Notion-like notebook.
        </p>
        ...
        {authMethod === 'email' ? (
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              ...
              className="w-full text-neutral-400 hover:text-neutral-300 text-sm py-2 transition"
            >
          ...
          <div className="space-y-4">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white text-neutral-950 font-semibold rounded-xl hover:bg-neutral-200 transition-all active:scale-[0.98] disabled:opacity-50"
            >
              <LogIn className="w-5 h-5" />
